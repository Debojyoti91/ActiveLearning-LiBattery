...
def active_learning_loop_no_weights(model, train_loader, test_loader, optimizer, n_steps=10, device='cpu'):
    ...
    with open('data/results/active_learning_no_weights_results.pkl', 'wb') as f:
        pickle.dump({
